# src/translators/cache_manager.py - v2.7.0
# Tác giả: Narga
# Chức năng: Quản lý cache kết quả dịch, thread-safe, lưu bằng pickle theo khóa băm MD5.
# Nâng cấp v2.7.0:
# - Thiết kế lại khóa cache để chống "reuse sai" khi thay đổi cấu hình/guidelines:
#   Khóa gồm: model_name, temperature, signature của prompts, hash previous_chunk_context, hash original_chunk.
# - Bổ sung API build_key() và get/set_by_components() để đồng bộ với robust_translate.
