...
def test_default_prompt_pref():
    from core.config import normalize_prefs
    assert normalize_prefs({})["default_prompt"] == "default_translation.txt"
    assert normalize_prefs({"default_prompt": "my.txt"})["default_prompt"] == "my.txt"
    assert normalize_prefs({"default_prompt": "x"})["default_prompt"] == "default_translation.txt"
    assert normalize_prefs({"default_prompt": "a/b.txt"})["default_prompt"] == "default_translation.txt"
